...
2. Find the newest release near the top of the list.
3. Download the file attached to that release.
4. If the file is in a ZIP folder, right-click it and choose Extract All.
5. Open the extracted folder.
6. Look for an app file, such as `.exe`, or a start file included in the release.
...
- `requirements.txt` for package setup
...
- Keep the release folder in a simple path like `Downloads` or `Desktop`
